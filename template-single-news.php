...
<div class="container">
    <div class="row">
     ...
     <div class="mt-4">
        <?php
        $featured_image_url = get_field('featured_image'); // Replace 'featured_image' with your custom field name
        if ($featured_image_url) {
            echo '<img src="' . esc_url($featured_image_url) . '" alt="" class="img-fluid" />';
        } else {
